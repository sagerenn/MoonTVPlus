...
(function () {
  ...
  function init() {
    ...
    if (state.detail && Array.isArray(state.detail.episodes) && state.detail.episodes.length) {
      selectEpisode(Math.max(0, Math.min(state.selectedEpisodeIndex || 0, state.detail.episodes.length - 1)), false);
    }
  ...
  function bindEvents() {
    ...
    elements.player.addEventListener('play', onPlayerStateChange);
    elements.player.addEventListener('playing', onPlayerStateChange);
    elements.player.addEventListener('volumechange', onPlayerStateChange);
    elements.player.addEventListener('durationchange', updatePlayerOverlay);
    elements.player.addEventListener('click', function () {
  ...
  function openRemotePlayCommand(_x22) {
